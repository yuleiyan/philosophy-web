...
import Picture2 from '/src/features/characters/masai/assets/images/2.webp';
import Picture from '/src/features/characters/masai/assets/images/masai.webp';


import MarkdownRenderer from '@/components/markdown-renderer';
import { MasaiTexts } from '@/features/characters/masai/assets/texts/masai-texts';
...
const Masai = () => {
    ...
    const elements = [
        ...
        {
            name: RoutesPaths.CHARACTERS.MASAI.title,
        ...
        <>
            <div className='my-[12vh]'>
                ...
                <div className='text-white mt-[10vh] container characters-text'>
                    <MarkdownRenderer texts={MasaiTexts} />
                </div>
            </div >
        </>
    );
...
export default TransitionLayout(Masai);