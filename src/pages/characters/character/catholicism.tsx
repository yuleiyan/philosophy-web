...
const Catholicism = () => {
    ...
    const elements = [
        ...
        {
            name: RoutesPaths.CHARACTERS.CATHOLICISM.title,
    ...
    return (
        <>
            <div className='my-[12vh]'>
                ...
                <h1 className='container text-white text-4xl font-bold'>{RoutesPaths.CHARACTERS.CATHOLICISM.title}</h1>
                ...
                <div className='text-white mt-[10vh] container characters-text'>
                    <MarkdownRenderer texts={CatholicismTexts} />
                </div>
            </div >
        </>
    );
...
export default TransitionLayout(Catholicism);